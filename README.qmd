...
-   TAZs are mostly made up of census tracts, but they're not exactly made up of blocks.
...
The final results are found in the `./output/data/FINAL` folder:

Area based methods: `./output/data/FINAL/area_allocation_tract.csv`

Rooftop based method: `./output/data/Old Data/rooftop_allocation_MPO_largest_in_each.csv`

All methods: `./output/data/Old Data/allocation_results_BosMPO.csv`
