...
tract_outliers <- TAZ_results_tract %>% 
  filter(ID %in% outliers$ID)
BG_outliers <- TAZ_results_BG %>% 
  filter(ID %in% outliers$ID)

write_csv(tract_outliers, "output/data/tract_outliers.csv")
write_csv(BG_outliers, "output/data/BG_outliers.csv")
