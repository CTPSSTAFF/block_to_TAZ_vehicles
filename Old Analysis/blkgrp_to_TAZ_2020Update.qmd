...
write_csv(allocation_results, "./output/data/allocation_results_BosMPO.csv")
...
ggsave(plot = last_plot(), 
  file = "PctMinorityComparison.png", 
  height = 8.5, width = 11, units = "in", 
  type = "cairo-png", dpi = 300, path = "./output/figures/")

ggsave(plot = last_plot(), 
  file = "PctMinorityComparison.png", 
  height = 8.5, width =11, units = "in", 
  type = "cairo-png", dpi = 300, path = "./images/")
