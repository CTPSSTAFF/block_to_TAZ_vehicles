...
saveRDS(TAZ_min_map, "Output/data/FINAL/TAZ_minority.rds")
saveRDS(TAZ_inc_map, "Output/data/FINAL/TAZ_lowincome.rds")
...
grid <- st_make_grid(TAZ_min_map, what = "centers",  n = c(40, 40), crs = 26986) 
mapview(grid[tract_min_map])+ mapview(tract_min_map, col.regions = "red")
...
ggplot(min_comp, aes(x=TAZ_min_pct, y = tract_pct_min)) + geom_point() + coord_equal() + geom_abline(slope = 1)
...
ggplot(inc_comp, aes(x=TAZ_lowinc_pct, y = tract_pct_lowinc)) + geom_point() + coord_equal() + geom_abline(slope = 1)
