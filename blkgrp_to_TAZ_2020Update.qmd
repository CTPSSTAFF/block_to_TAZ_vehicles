...
write_csv(roof_shares_ratio, file = "./output/data/rooftop_allocation_plymouth_largest_in_each.csv")
...
allocation_results <- full_join(area, roof, by = join_by(ID, GEOID))
...
allocation_results <- allocation_results |> 
  left_join(minority_tidy, by = join_by(GEOID))
```

### Testing

Check that we have retained all of our GEOID area.
