...
x <- head(intersections_clean, 20)
mapview(x, zcol = "GEOID") + mapview(TAZ_land, col.regions = "red") + mapview(blk_groups_land, col.regions = "yellow")
...
roofs_in_intersect <- st_join(intersections, rooftops)

# This below is taking too long to run
